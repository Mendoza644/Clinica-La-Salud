...
public class UpdateLog extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dossiers dossier = (Dossiers) getIntent().getSerializableExtra("dossier");
        if (dossier != null) {
            currentTime = dossier.getTime();
            currentDate = dossier.getDate();
            date.setText(dossier.getDate());
            time.setText(dossier.getTime());
            nameInput.setText(dossier.getName());
            ageInput.setText(dossier.getAge());
            heightInput.setText(dossier.getHeight());
            weightInput.setText(dossier.getWeight());
            phoneInput.setText(dossier.getPhone());
            sicknessInput.setText(dossier.getSickness());
            historyInput.setText(dossier.getHistory());
            backgroundInput.setText(dossier.getBackgroundRecord());
            physicalInput.setText(dossier.getPhysicalTest());
            diagnoseInput.setText(dossier.getDiagnose());
            treatmentInput.setText(dossier.getTreatment());
            createLogButton.setText(getResources().getString(R.string.update_log_btn));
        }
    ...
    public void onCheckClicked(View view) {
        ...
        if (view.getId() == R.id.checkbox_confirmation) {
            if (state) {
                ...
                createLogButton.setOnClickListener(v -> updateDossier());
            } else {
